...
export default function NotFound() {
  return (
    <div className="min-h-[80vh] flex items-center justify-center pt-28 pb-16 bg-[#F4F2EE] px-4">
      <div className="max-w-md w-full text-center bg-white border border-[#D5D4D0] p-8 sm:p-12 rounded-none">
        <div className="w-14 h-14 mx-auto mb-6 bg-[#F3D8C7]/50 border border-[#D96B27]/30 flex items-center justify-center text-[#D96B27] rounded-none">
