...
import { ArrowUpRight, Truck, ShieldCheck, Scale, CheckCircle2, PhoneCall } from "lucide-react";
...
export const metadata: Metadata = {
  ...
  description:
    "Primary supplier of construction materials: cement, TMT steel, red clay bricks, AAC blocks, sand, aggregates, plumbing, and electrical materials with direct jobsite delivery.",
};
    ...
    <div className="pt-28 pb-20 bg-[#0B0D0F]">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="max-w-3xl">
          ...
          <p className="text-base sm:text-lg text-[#A7ADB3] leading-relaxed">
            Our primary business deals in the sale and supply of essential construction materials: cement, TMT steel, red clay bricks, AAC blocks, sand, aggregates, plumbing, and electrical supplies with dependable site delivery for residential and commercial building projects.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="p-6 bg-[#15191D] border border-[#2A3035]">
            ...
            <p className="text-xs text-[#A7ADB3] leading-relaxed">
              Transparent weighbridge slips and accurate bag and bundle counts with zero volumetric discrepancies.
            </p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-24">
        <SectionHeading
          ...
          description="Browse product categories, specifications, and availability. Contact us for today's pricing and bulk order delivery schedules."
        />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8">
              ...
              <p className="text-xs sm:text-sm text-[#A7ADB3] leading-relaxed">
                Constructing a residential building, apartment floors, or commercial shops? GG Construction Co. coordinates regular truckload dispatches of cement, steel, sand, and bricks so your project never halts for lack of materials.
              </p>
            </div>
