        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7 space-y-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="p-6 bg-white border border-[#D5D4D0] shadow-sm">
              ...
              <div className="p-6 bg-white border border-[#D96B27]/40 shadow-sm">
                <span className="text-xs uppercase tracking-wider font-bold text-[#D96B27] block mb-2">
            ...
            <div>
              ...
              <div className="border border-[#D5D4D0] divide-y divide-[#D5D4D0] text-sm shadow-sm">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                <div className="p-4 bg-white border border-[#D5D4D0] shadow-sm">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            {/* Action Box */}
            <div className="p-6 bg-white border border-[#D96B27]/40 shadow-sm text-center">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-24">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {project.galleryImages.map((imgUrl, idx) => (
              <div
                key={idx}
                className="relative aspect-[16/10] bg-white border border-[#D5D4D0] shadow-sm overflow-hidden group"
              >
                <Image
                  src={imgUrl}
