...
export const projectsData: ProjectItem[] = [
  {
    ...
    clientTypePlaceholder: "[REPRESENTATIVE RESIDENTIAL CLIENT]",
    projectValuePlaceholder: "[ITEMIZED MILESTONE ESTIMATE]",
    ...
    engineeringHighlights: [
      {
        ...
        description:
          "Monitored proper water-cement ratios and maintained standard 14 to 21-day curing cycles for optimal slab and column strength.",
      },
      {
        title: "Damp-Proof Course (DPC) Installation",
        description:
          "Carefully placed plinth-level DPC membranes to prevent capillary moisture rise into ground-floor walls.",
      },
    ],
    overview:
      "Representative project example illustrating GG Construction Co.'s low-rise building construction capabilities for residential structures up to 4 floors. GG Construction Co. has carried out construction work across Rohini, Pitampura and nearby areas of Delhi, focusing on dependable material usage, solid masonry, and tidy structural execution.",
    challenge:
      "Managing structural construction and material delivery within a compact residential plot with narrow neighborhood access.",
    solution:
      "Scheduled phased cement, sand, and aggregate drop-offs directly to the site to prevent street blockage while maintaining steady pouring schedules.",
  ...
  },
  {
    ...
    clientTypePlaceholder: "[REPRESENTATIVE HOMEOWNER]",
    projectValuePlaceholder: "[ITEMIZED MILESTONE ESTIMATE]",
    isRepresentativePlaceholder: true,
    heroImage:
    ...
    engineeringHighlights: [
      {
        ...
        description:
          "Compacted excavation trenches mechanically and laid a lean concrete mud mat prior to steel footing cage positioning.",
      },
    ],
    overview:
      "Representative residential build demonstrating practical house construction from ground breaking to finishing handover. Reflects genuine local building experience in Pitampura and nearby Delhi localities.",
    challenge:
      "Ensuring effective basement and ground-level water protection during the monsoon season.",
    solution:
      "Integrated waterproofing compound into foundation concrete and applied dual-layer bitumen coatings to external sub-grade masonry.",
  ...
  },
  {
    ...
    location: "Rohini Commercial Pocket [Representative Example]",
    status: "Completed",
    year: "Representative Scope",
    builtUpArea: "Approx. 9,500 Sq. Ft.",
    floors: "G+3 (4 Floors)",
    timeline: "11–13 Months",
    clientTypePlaceholder: "[REPRESENTATIVE COMMERCIAL OWNER]",
    projectValuePlaceholder: "[ITEMIZED MILESTONE ESTIMATE]",
    isRepresentativePlaceholder: true,
    heroImage:
    ...
    scope: [
      ...
      "Toughened glass storefront provisions and exterior finishes",
    ...
    engineeringHighlights: [
      {
        ...
        description:
          "Cast reinforced slabs designed for typical commercial office and retail storage loads (3.0 to 4.0 kN/m²).",
      },
    ],
    overview:
      "Representative commercial building project showcasing small-to-medium commercial construction up to 4 floors. Demonstrates low-rise construction capabilities across commercial pockets of Rohini and nearby Delhi areas.",
    challenge:
      "Creating wide, clear spans on the ground floor to maximize retail visibility without excessive column intrusions.",
    solution:
      "Carefully positioned heavy-section RCC transfer beams to balance upper-floor column loads onto peripheral structural points.",
  ...
  },
  {
    ...
    location: "North-West Delhi [Representative Example]",
    status: "Completed",
    year: "Representative Scope",
    builtUpArea: "Approx. 12,000 Sq. Ft.",
    floors: "G+4 (5 Floors)",
    timeline: "13–15 Months",
    clientTypePlaceholder: "[REPRESENTATIVE PROPERTY OWNER]",
    projectValuePlaceholder: "[ITEMIZED MILESTONE ESTIMATE]",
    isRepresentativePlaceholder: true,
    heroImage:
    ...
    keyFeatures: [
      "Dual-use design: ground commercial retail and quiet upper floors",
    ...
    engineeringHighlights: [
      {
        ...
        description:
          "Consistent concrete vibrator compaction during pours to prevent honeycomb formation across all 5 levels.",
      },
    ],
    overview:
      "Representative 5-floor building project demonstrating GG Construction Co.'s typical maximum construction scale (approximately 4–5 floors). Combining ground commercial use with upper residential living.",
    challenge:
      "Separating plumbing and electrical distribution lines between commercial tenants and residential upper floors.",
    solution:
      "Built two separate vertical service shafts allowing independent maintenance and metering without cross-interference.",
  ...
  },
  {
    ...
    sector: "commercial",
    sectorLabel: "Commercial",
    location: "Pitampura / Local Market Area [Representative Example]",
    status: "Completed",
    year: "Representative Scope",
    builtUpArea: "Approx. 5,000 Sq. Ft.",
    floors: "G+2 (3 Floors)",
    timeline: "7–9 Months",
    clientTypePlaceholder: "[REPRESENTATIVE RETAIL OWNER]",
    projectValuePlaceholder: "[ITEMIZED MILESTONE ESTIMATE]",
    isRepresentativePlaceholder: true,
    heroImage:
    ...
    engineeringHighlights: [
      {
        ...
        description:
          "Organized synchronized brick masonry and electrical conduit chasing to complete civil work within estimated milestones.",
      },
    ],
    overview:
      "Representative 3-floor commercial building for local businesses, clinics, or retail shops across market areas of Pitampura and Delhi. High utility, low maintenance costs, and durable civil specifications.",
    challenge:
      "Rapid execution within a busy market area with restricted unloading hours.",
    solution:
      "Coordinated early morning material deliveries and efficient on-site storage to keep construction moving without disruptions.",
  ...
  },
  {
    ...
    location: "Rohini / Residential Sector [Representative Example]",
    status: "Completed",
    year: "Representative Scope",
    ...
    engineeringHighlights: [
      {
        ...
        description:
          "Replaced conventional heavy red bricks with lightweight autoclave aerated concrete (AAC) blocks to ensure safe floor addition on existing foundations.",
      },
    ],
    overview:
      "Representative renovation and floor addition showcasing practical home improvement, structural expansion, and damp-proofing for existing residential buildings in Rohini and nearby Delhi areas.",
    challenge:
      "Carrying out upper floor construction while the ground floor remained occupied by the family.",
    solution:
      "Installed temporary external scaffolding and safety netting, with designated access pathways to minimize noise, dust, and disturbance.",
