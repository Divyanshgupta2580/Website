    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <Link
            href="/"
            className="flex items-center gap-3 group focus-visible:ring-2 focus-visible:ring-[#D96B27] rounded-none"
            aria-label="GG Construction Co. Home"
          >
            {/* Monogram Brand Mark */}
            <div className="w-9 h-9 rounded-none bg-[#18324A] flex items-center justify-center text-white font-extrabold text-sm tracking-tighter">
              GG
            </div>
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`px-3 py-2 text-xs uppercase tracking-wider font-bold transition-colors relative rounded-none ${
                    isActive
                      ? "text-[#D96B27]"
          ...
          <div className="flex items-center gap-2.5 lg:hidden">
            ...
            <button
              ...
              className="w-9 h-9 border border-[#D5D4D0] bg-[#F4F2EE] rounded-none flex items-center justify-center text-[#18324A] hover:border-[#18324A] focus-visible:ring-2 focus-visible:ring-[#D96B27]"
            >
              {isMobileMenuOpen ? (
          ...
          <div className="mt-8 pt-6 border-t border-[#D5D4D0] space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <a
                ...
                className="flex items-center justify-center gap-2 py-3 px-3 text-xs uppercase tracking-wider text-[#18324A] font-bold border border-[#D5D4D0] bg-[#F4F2EE] hover:border-[#18324A] rounded-none transition-colors"
