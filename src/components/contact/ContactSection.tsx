  ...
  return (
    ...
    >
      <Container size="default">
        {/* Main Contact Card */}
        <div className="bg-white border border-[#D5D4D0] p-8 sm:p-12 lg:p-14 rounded-sm shadow-sm mb-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-7 space-y-5">
              ...
              <div className="pt-3 flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-white border border-[#D5D4D0] hover:border-[#18324A] text-[#18324A] font-bold text-xs uppercase tracking-wider rounded-sm transition-colors"
                >
            ...
            <div className="lg:col-span-5 bg-[#F4F2EE] border border-[#D5D4D0] p-6 sm:p-8 rounded-sm space-y-6">
              <div>
            ...
            {enquiryChoices.map((item) => {
              ...
              return (
                <Link
                  key={item.index}
                  href={item.href}
                  className="group bg-white border border-[#D5D4D0] p-6 sm:p-7 rounded-sm flex flex-col justify-between hover:border-[#18324A] hover:shadow-sm transition-all"
                >
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-wider text-[#D96B27] bg-[#F3D8C7] px-2 py-0.5 rounded-xs">
                        {item.badge}
                      </span>
                    </div>
