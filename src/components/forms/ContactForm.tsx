...
export default function ContactForm() {
  ...
  return (
    <div className="bg-white border border-[#D5D4D0] p-6 sm:p-10 rounded-none" id="enquiry-form">
      {/* Category Selector */}
      <div className="mb-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
          <button
            ...
            className={`flex items-center gap-2.5 p-3 text-left border rounded-none transition-all ${
      ...
      {submitStatus === "success" && (
        <div className="mb-6 p-5 bg-[#F4F2EE] border-2 border-[#D96B27] rounded-none text-left">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              {referenceId && (
                <div className="mt-3 inline-flex items-center gap-2 px-2.5 py-1 bg-white border border-[#D5D4D0] rounded-none text-[11px] font-bold text-[#18324A]">
      ...
      {/* Error Notification */}
      {submitStatus === "error" && (
        <div className="mb-6 p-4 bg-red-50 border border-red-300 rounded-none text-left flex items-start gap-3">
