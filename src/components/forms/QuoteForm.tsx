...
export default function QuoteForm() {
  ...
  return (
    <div className="bg-white border border-[#D5D4D0] p-6 sm:p-10 lg:p-12 rounded-none relative overflow-hidden">
      {/* Top Accent Line */}
      ...
      {submitStatus === "success" && (
        <div className="mb-8 p-6 bg-[#F4F2EE] border-2 border-[#D96B27] rounded-none text-left">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              {referenceId && (
                <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-white border border-[#D5D4D0] rounded-none text-xs font-bold text-[#18324A]">
      ...
      {/* Error Notification */}
      {submitStatus === "error" && (
        <div className="mb-8 p-5 bg-red-50 border border-red-300 rounded-none text-left flex items-start gap-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 bg-white border rounded-none text-xs text-[#20272D] placeholder-[#66717A] focus:outline-none transition-colors ${
            ...
            <div className="sm:col-span-2">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-white border border-[#D5D4D0] rounded-none text-xs text-[#20272D] placeholder-[#66717A] focus:outline-none focus:border-[#D96B27] transition-colors"
              />
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 bg-white border border-[#D5D4D0] rounded-none text-xs text-[#20272D] focus:outline-none focus:border-[#D96B27] transition-colors"
              >
