        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-6 border-t border-[#D5D4D0]">
              <div className="bg-white p-3.5 border border-[#D5D4D0] rounded-none">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative aspect-[4/3] sm:aspect-[16/11] lg:aspect-[4/5] w-full rounded-none overflow-hidden border border-[#D5D4D0] bg-[#E8E6E1]">
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-white/95 border border-[#D5D4D0] p-3.5 rounded-none backdrop-blur-xs">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="px-2 py-0.5 bg-[#E8E6E1] text-[#66717A] text-[9px] font-bold uppercase tracking-wider rounded-none border border-[#D5D4D0]">
